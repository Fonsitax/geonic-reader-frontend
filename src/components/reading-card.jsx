...
const ReadingCard = ({ id, image, country, title, onFavorite, onRemoveFavorite, hideButtons }) => {
    ...
    return (
        ...
        <div
            className="max-w-sm bg-gray-100 border border-indigo-200 rounded-xl hover:shadow-2xl shadow-inner dark:bg-indigo-950 dark:border-indigo-700 ">
            ...
            <div className="p-5 text-center">
                <span className="font-medium uppercase text-indigo-500">
                    {country}
                </span>
                <div className=" p-2 text-2xl font-medium tracking-tight text-indigo-900">
                    {title}
                </div>
