                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div className="lg:w-1/2">
                        <h1 className="mb-6 text-4xl font-extrabold tracking-tight leading-none text-indigo-900 md:text-5xl lg:text-6xl relative group">
                            ...
                            <span
                                className="absolute bottom-[-8px] left-0 w-full h-[2px] bg-indigo-800 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
                        </h1>
                        <p className="mb-10 text-lg font-normal text-indigo-800 lg:text-xl sm:px-16 lg:px-0">
                            Unlock fascinating geography facts from every corner of the globe. Dive into interactive
                            cards and discover new insights with each click. Enhance your learning with our Bionic
                            Reading method, designed to help you grasp and remember information faster and more
                            efficiently.
                        </p>
