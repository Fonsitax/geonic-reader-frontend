...
const SearchBar = ({ onSearch }) => {
    ...
    return (
        <div className="relative">
            ...
            {showPopover && (
                <div className="max-w-4xl mx-auto mt-2 p-4 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg shadow-lg dark:bg-gray-800 dark:text-white dark:border-gray-700">
            ...
            <div className="border-t border-gray-300 dark:border-gray-700 my-6 mx-auto w-full max-w-4xl">
                {/* Sophisticated Quote about Learning Geography */}
